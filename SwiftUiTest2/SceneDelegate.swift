...
//        if let shortcut = connectionOptions.shortcutItem as? UIApplicationShortcutItem{
//            print(shortcut.type)
//        } else {
//            print("nice")
//        }
    ...
    func windowScene(_ windowScene: UIWindowScene, performActionFor shortcutItem: UIApplicationShortcutItem, completionHandler: @escaping (Bool) -> Void) {
        ...
        NotificationCenter.default.post(name: NSNotification.Name(rawValue: "copy-code-noti"), object: nil, userInfo: ["copy": copy])
